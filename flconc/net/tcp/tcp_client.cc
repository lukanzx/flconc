...
namespace flconc {
    ...
    TcpClient::TcpClient(NetAddress::ptr addr, ProtocalType type /*= FlconcPb_Protocal*/) : m_peer_addr(addr) {
        ...
        m_local_addr = std::make_shared<flconc::IPAddress>("127.0.0.1", 0);
    ...
    void TcpClient::resetFd() {
        flconc::FdEvent::ptr fd_event = flconc::FdEventContainer::GetFdContainer()->getFdEvent(m_fd);
    ...
    int TcpClient::sendAndRecvFlconcPb(const std::string &msg_no, FlconcPbStruct::pb_ptr &res) {
